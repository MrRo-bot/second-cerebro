...
const NoteCard = ({ noteData }: { noteData: NoteType }) => {
  ...
  return (
    <Card className="relative h-full flex-col flex justify-between overflow-visible hover:ring-2 focus:ring-2 focus-visible:ring-2 transition rounded-lg! py-3!">
      <Link
